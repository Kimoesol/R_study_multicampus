...
for(i in 1:x){
  ...
  long = remDr$findElements('css selector',paste('#mCSB_3_container > ul > li:nth-child(',i,')'))
  long_attr = sapply(long, function(x){x$getElementAttribute('data-long')})
  print(long_attr)
